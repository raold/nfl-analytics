...
class PhaseComparator:
    ...
    def load_phase21(self) -> dict:
        ...
        print("✓ Loaded Phase 2.1 results")
        return normalized
    ...
    def calculate_improvements(self) -> dict:
        ...
        improvements["coverage_90_rel"] = (
            ...
            * 100
            if (90 - self.phase1_results["coverage_90"] * 100) != 0
            else 0
        )

        improvements["mae_rel"] = (improvements["mae_abs"] / self.phase1_results["mae"]) * 100
    ...
    def print_comparison(self):
        ...
        print(
            f"{'90% CI Coverage':<25} {p1_cov90:>6.1f}%{'':<8} {p21_cov90:>6.1f}%{'':<8} "
        ...
        print(
            f"{'68% CI Coverage':<25} {p1_cov68:>6.1f}%{'':<8} {p21_cov68:>6.1f}%{'':<8} "
            f"{improvements['coverage_68_abs']:>+6.1f} pp{'':<8}"
        )

        # MAE
        print(
            f"{'MAE (yards)':<25} {self.phase1_results['mae']:>6.2f}{'':<9} "
        ...
        # RMSE
        print(
            f"{'RMSE (yards)':<25} {self.phase1_results['rmse']:>6.2f}{'':<9} "
    ...
    def create_comparison_plot(self, output_path: Path):
        ...
        ax.barh(
            list(improvements_data.keys()),
            list(improvements_data.values()),
            color=colors,
            alpha=0.8,
        )
...
def main():
    ...
    try:
        ...
        # Save LaTeX table
        latex_path = Path(
            "/Users/dro/rice/nfl-analytics/analysis/dissertation/figures/out/phase_comparison_table.tex"
        )
