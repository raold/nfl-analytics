...
def generate_copula_figure(rho_range=None, n_samples=100000, seed=42):
    ...
    empirical_probs = [
        empirical_joint_exceedance(rho, n_samples=n_samples, seed=seed)
...
def main():
    ...
    output_path = Path(__file__).parent.parent.parent / 'analysis' / 'dissertation' / 'figures' / 'joint_exceedance_vs_rho.png'
    ...
    for rho in test_rhos:
        ...
        print(f"  rho={rho:5.2f}: Analytic={analytic:.4f}, Empirical={empirical:.4f}, Diff={abs(analytic-empirical):.4f}")
