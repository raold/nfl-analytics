...
class DeepBNNv2:
    ...
    def build_model(self, X_train, y_train):
        ...
        with pm.Model() as model:
            ...
            alpha_1 = pm.Normal(
                "alpha_1", mu=0, sigma=0.1
            )  # Feature-dependent adjustment (smaller)
    ...
    def train(self, X_train, y_train, n_samples=2000, n_tune=1000, n_chains=4):
        ...
        """
        print("Building BNN v2.0 (Deep Architecture)")
        ...
        summary = az.summary(
            self.trace, var_names=["W1", "W2", "W3", "W_out", "alpha_0", "alpha_1"]
        )
        print(summary)
    ...
    def predict(self, X_test, return_std=True):
        ...
        with self.model:
            ...
            posterior_pred = pm.sample_posterior_predictive(
                self.trace, var_names=["y_obs"], progressbar=False
            )

        # Extract predictions (in log space)
        y_pred_samples_log = posterior_pred.posterior_predictive[
            "y_obs"
        ].values  # (chain, draw, N_test)
