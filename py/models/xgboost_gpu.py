#!/usr/bin/env python3
"""
XGBoost GPU-accelerated trainer for NFL spread prediction.
...
Usage:
    ...
    python py/models/xgboost_gpu.py \
        --features-csv data/processed/features/asof_team_features_enhanced.csv \
        --start-season 2010 \
        --end-season 2024 \
        --output models/xgboost/best_model.json
    ...
    python py/models/xgboost_gpu.py \
        ...
        --end-season 2024 \
        --sweep \
        --output-dir models/xgboost/sweep
"""
...
def load_and_prepare_data(
    ...
    print(f"Target balance: {df['home_cover'].mean():.3f}")
