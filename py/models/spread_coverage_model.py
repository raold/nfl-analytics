...
class SpreadCoverageModel:
    ...
    def __init__(self, db_config: Dict = None):
        ...
        self.base_features = [
            ...
            'pass_epa_l5_diff', 'rush_epa_l5_diff',
            'win_pct_diff',

            # Betting features
            'spread_close', 'total_close', 'home_over_rate_l10',

            # Rolling stats - home
            'home_points_l3', 'home_points_against_l3', 'home_success_rate_l3',
            'home_points_l5', 'home_points_against_l5', 'home_epa_per_play_l5',
            'home_success_rate_l5', 'home_pass_epa_l5', 'home_rush_epa_l5',
            'home_points_l10', 'home_points_against_l10', 'home_epa_per_play_l10',

            # Rolling stats - away
            'away_points_l3', 'away_points_against_l3', 'away_success_rate_l3',
            'away_points_l5', 'away_points_against_l5', 'away_epa_per_play_l5',
            'away_success_rate_l5', 'away_pass_epa_l5', 'away_rush_epa_l5',
            'away_points_l10', 'away_points_against_l10', 'away_epa_per_play_l10',

            # Season stats
            'home_points_season', 'home_points_against_season', 'home_epa_per_play_season',
            'home_success_rate_season',
            'away_points_season', 'away_points_against_season', 'away_epa_per_play_season',
            ...
            # Venue
            'venue_home_win_rate', 'venue_avg_margin', 'venue_avg_total',
            'is_dome', 'is_outdoor', 'is_cold_game', 'is_windy_game',
...
def main():
    ...
    parser.add_argument('--features-csv',
                       default='data/processed/features/asof_team_features_v3.csv')
