...
def calculate_metrics(df, pred_col, actual_col, pred_q05_col, pred_q95_col):
    ...
    in_ci = (df[actual_col] >= df[pred_q05_col]) & (df[actual_col] <= df[pred_q95_col])
...
def main():
    ...
    metrics_2024_v1 = calculate_metrics(
        comparison_2024, "pred_yards_v1", "actual_yards", "pred_q05_v1", "pred_q95_v1"
    )
    metrics_2024_v2_5 = calculate_metrics(
        comparison_2024, "pred_yards_v2_5", "actual_yards", "pred_q05_v2_5", "pred_q95_v2_5"
    )

    metrics_2025_v1 = calculate_metrics(
        comparison_2025, "pred_yards_v1", "actual_yards", "pred_q05_v1", "pred_q95_v1"
    )
    metrics_2025_v2_5 = calculate_metrics(
        comparison_2025, "pred_yards_v2_5", "actual_yards", "pred_q05_v2_5", "pred_q95_v2_5"
    )
    ...
    ax2.scatter(
        comparison_2024["actual_yards"],
        comparison_2024["pred_yards_v2_5"],
        alpha=0.6,
        s=80,
        color="green",
    )
    ...
    ax4.scatter(
        comparison_2025["actual_yards"],
        comparison_2025["pred_yards_v2_5"],
        alpha=0.6,
        s=80,
        color="green",
    )
    ...
    v2024_v1 = [
        metrics_2024_v1["mae"],
        metrics_2024_v1["rmse"],
        metrics_2024_v1["correlation"] * 100,
    ]
    v2024_v2_5 = [
        metrics_2024_v2_5["mae"],
        metrics_2024_v2_5["rmse"],
        metrics_2024_v2_5["correlation"] * 100,
    ]
    v2025_v1 = [
        metrics_2025_v1["mae"],
        metrics_2025_v1["rmse"],
        metrics_2025_v1["correlation"] * 100,
    ]
    v2025_v2_5 = [
        metrics_2025_v2_5["mae"],
        metrics_2025_v2_5["rmse"],
        metrics_2025_v2_5["correlation"] * 100,
    ]
    ...
    mae_imp_2024 = (
        (metrics_2024_v1["mae"] - metrics_2024_v2_5["mae"]) / metrics_2024_v1["mae"]
    ) * 100
    mae_imp_2025 = (
        (metrics_2025_v1["mae"] - metrics_2025_v2_5["mae"]) / metrics_2025_v1["mae"]
    ) * 100
    ...
    plt.suptitle(
        "Comprehensive Model Comparison: v1.0 vs v2.5 (2024 + 2025)",
        fontsize=16,
        fontweight="bold",
        y=0.995,
    )
