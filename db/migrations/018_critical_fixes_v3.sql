-- ============================================================================
-- CRITICAL DATABASE FIXES - MIGRATION 018 v3 (Idempotent Version)
...
-- STEP 2: Drop dependent views before recreating functions
-- ============================================================================

DROP VIEW IF EXISTS public.v_games_normalized CASCADE;
DROP VIEW IF EXISTS public.v_rosters_with_player_info CASCADE;


-- STEP 3: Team normalization function
-- ============================================================================

DROP FUNCTION IF EXISTS public.normalize_team_abbr(TEXT) CASCADE;
...
-- STEP 4: Player ID lookup function
-- ============================================================================

DROP FUNCTION IF EXISTS public.lookup_player_ids(TEXT,TEXT,TEXT,TEXT) CASCADE;
...
-- STEP 6: Add primary key to rolling_features
-- ============================================================================
...
-- STEP 10: Create summary of changes
-- ============================================================================
