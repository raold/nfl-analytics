...
Chapter~\ref{chap:risk} quantifies uncertainty and translates it into stake sizing and tail‑risk controls (fractional Kelly, CVaR), making policies deployable in practice.
}
...
\begin{table}[t]
  ...
  \begin{threeparttable}
    ...
    \setlength{\tabcolsep}{4.5pt}\renewcommand{\arraystretch}{1.12}
    \begin{tabularx}{\linewidth}{@{} p{0.20\linewidth} X X X @{} }
      \toprule
...
Chapter~\ref{chap:risk} formalizes stake sizing and portfolio risk controls; Chapter~\ref{chap:sim} validates policies under dependence and frictions before promotion.
}
