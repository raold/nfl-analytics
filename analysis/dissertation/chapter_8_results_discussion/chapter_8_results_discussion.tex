...
We report out-of-sample performance by season. If a pre-rendered table is present, we include it; otherwise we fall back to an inline table with placeholder rows.
\IfFileExists{../results/oos_record_table.tex}{\input{../results/oos_record_table.tex}}{%
\begin{table}[t]
  \centering
  \small
  ...
  \begin{threeparttable}
    ...
    \begin{tabularx}{\linewidth}{@{} c X r r r r r r r @{} }
      ...
      2021 & Baseline (GLM)      & -- & --    & --    & --   & --   & --    & -- \\
      2021 & Offline RL (IQL)    & -- & --    & --    & --   & --   & --    & -- \\
      2022 & Baseline (Skellam)  & -- & --    & --    & --   & --   & --    & -- \\
      2022 & Offline RL (CQL)    & -- & --    & --    & --   & --   & --    & -- \\
      2023 & Ensemble            & -- & --    & --    & --   & --   & --    & -- \\
      2023 & Offline RL (TD3+BC) & -- & --    & --    & --   & --   & --    & -- \\
      2024 & Offline RL (IQL)    & -- & --    & --    & --   & --   & --    & -- \\
      \bottomrule
    \end{tabularx}
...
\IfFileExists{../results/zero_weeks_table.tex}{\input{../results/zero_weeks_table.tex}}{%
\begin{table}[t]
  \centering
  \small
  \begin{adjustbox}{max width=\linewidth}
  \begin{threeparttable}
    ...
    \begin{tabularx}{\linewidth}{@{} c r r r r >{\RaggedRight\arraybackslash}X @{} }
      ...
      2023 & 23 & 6  & 5  & 1  & DR lower bound < 0 across clip grid \\
      2024 & 23 & 5  & 4  & 1  & Liquidity caps bound EV; CVaR gate \\
      \bottomrule
    \end{tabularx}
    \begin{tablenotes}[flushleft]\footnotesize\RaggedRight
...
\begin{table}[t]
  ...
  \begin{adjustbox}{max width=\linewidth}
  \begin{threeparttable}
    \caption{Core ablation grid (placeholder unless included): baseline vs RL; reweighting on/off; microstructure features on/off; Gaussian vs $t$‑copula.}
