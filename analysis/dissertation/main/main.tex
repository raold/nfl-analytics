...
% ---------------------------------------------------
% Enhanced Table & Typography Packages
% ---------------------------------------------------
\usepackage{siunitx}              % Consistent numeric formatting (#24)
\usepackage{makecell}             % Better column headers with line breaks (#4)
\usepackage{colortbl}             % Row coloring for zebra striping (#5)
\usepackage[titles]{tocloft}      % Better TOC/LOF/LOT control (fix orphans)
...
% Right-aligned column for numeric data (#1)
\newcolumntype{R}[1]{>{\raggedleft\arraybackslash}p{#1}}
% siunitx numeric column for automatic alignment (#1, #24)
...
% Helper commands for consistent table formatting
% #4: Better header command with automatic line breaks
\renewcommand{\thead}[1]{\multicolumn{1}{c}{\bfseries\makecell{#1}}}
% #7: Heavier rule for baseline separation
\newcommand{\baselinerule}{\midrule[0.08em]}
...
% Insert notation glossary and acronyms after lists (front matter)
\cleardoublepage
\phantomsection
