...
% NOTE: newpx fonts disabled due to figureversions incompatibility (requires LaTeX 2024-11-01+)
% Using standard LaTeX fonts instead for compatibility with MiKTeX 24.1 (LaTeX 2023-11-01)
\usepackage{mathpazo} % Palatino font for text and math (alternative without figureversions dependency)
...
% Note: These tables are included within their respective chapters to avoid multiply-defined labels
% Commented out to prevent duplication
...
\section{Conservative Q-Learning Performance}
...
\IfFileExists{../figures/out/cql_performance_table.tex}{\input{../figures/out/cql_performance_table.tex}}{}

\begin{figure}[htbp]
\centering
\IfFileExists{../figures/out/cql_training_curves.png}{%
  \includegraphics[width=0.95\textwidth]{../figures/out/cql_training_curves.png}
...
% Removed redundant appendix chapters to streamline dissertation
% Key content consolidated into main Technical Appendix above
...
% Removed redundant Experiment Registry (Extended) - 100 experiments already covered

% Removed Paper-Trading Logs chapter - contained only illustrative/mock data
