...
With a governed data foundation ensuring temporal integrity, \Cref{chap:baseline} develops calibrated baseline models (GLM, state-space, Bayesian hierarchical, Dixon-Coles) that leverage these 170+ features to produce reliable probability estimates for spreads, totals, and moneylines.
}
