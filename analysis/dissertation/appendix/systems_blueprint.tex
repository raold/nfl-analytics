\chapter[Systems Blueprint]{Systems Blueprint: From Research to Production}
\label{app:systems-blueprint}

% Local typesetting relaxation to reduce Underfull \hbox warnings in prose below
\begingroup\sloppy
